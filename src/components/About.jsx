    ...
    >
      ...
      >
        <div className="w-full">
          ...
          Exploration of how facial recognition is used for controlling access in education
         and the changing ways of schools and colleges in addressing privacy and security.
          </p>
        </div>
        <div
          style={{
