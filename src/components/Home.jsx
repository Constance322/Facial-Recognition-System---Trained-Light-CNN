    ...
    >
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`} style={{ height: '100%', overflow: 'hidden' }}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-2`}>
          <span style={{ color: 'white' }}>Strengthening safety measures within Educational Institutions</span>
        </p>
      </div>

      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`} style={{ height: '100%', overflow: 'hidden', position: 'relative' }}>
        <img
          src={face}
          alt="billing"
          className="w-[100%] h-[80%] relative z-[5] rounded-md"
